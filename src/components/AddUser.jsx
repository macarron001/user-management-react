...
const AddUser = ({ setIsAddingUser, setReRender, reRender }) => {
  ...
  useEffect(() => {
    if(isSubmitSuccessful) {
      ...
      axios({
        ...
        url: `https://ronald-exam-api.herokuapp.com/create`,
        headers: {
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-[600px] bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-2 flex-auto">
              <form 
                ...
                <button className='w-full my-5 py-2 bg-teal-500 shadow-lg shadw-teal-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg' type='submit'>Register</button>
              </form>
            </div>
